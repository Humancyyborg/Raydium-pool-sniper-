...
import {   tokenBaseInfo } from "../config"; 
...
export type TransactionWithSigners = {
  ...
  export const PROGRAMIDS =tokenBaseInfo.devnet? DEVNET_PROGRAM_ID: MAINNET_PROGRAM_ID;
  ...
  export const feeId = tokenBaseInfo.devnet? new PublicKey("3XMrhbv989VxAMi3DErLV9eJht1pHppW5LbKxe9fkEFR"):new PublicKey("7YttLkHDoNj9wyDur5pM1ejNaAvT9X4eqaYcHQqtj2G5")